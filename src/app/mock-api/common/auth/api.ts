...
import {  user, user as userData } from 'app/mock-api/common/user/data';
            ...
            .reply(({request}) => {
                ...
                if ( request.body.email === 'admin@admin.com' && request.body.password === 'admin123' )
                {
                    this._user.forEach(element => {
                        if(request.body.email === element.email){
                            this.user = {
                                id:element.id,
                                name:element.name,
                                email:element.email,
                ...
                // Sign in successful
                //User
                if ( request.body.email === 'hughes.brian@company.com' && request.body.password === 'azerty' )
                {
